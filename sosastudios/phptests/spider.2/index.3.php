...
<script>
   ...
   /*     query = document.getElementById('queryword').value;
       ...
       xhr.onload = function (){
        ...
        document.getElementById("circle0").innerHTML+= "<p>" + item.htmlTitle;//get rid maybe
...
<script src="js/buildWeb.js"></script>
    ...
    <div class ="justify-content-md-center position-absolute">
...
echo '   <div class="container form-inline">
        ...
        <button class="btn btn-outline-success my-2 my-sm-0" name="query-submit" onclick="buildWeb();">Search</button>
