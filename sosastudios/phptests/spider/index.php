...
if (isset($_SESSION['userId'])){
  ...
  if ($_GET['query'] == 'success'){
    echo ' <button class="btn btn-success my-2 my-sm-0" onclick="buildWebs()">build web</button><br>
    <form class="form-inline mt-2 mt-md-0" action="includes/query.inc.php" method="POST">
    <input type="hidden" value="" name="query"/>
    <button type="button" class="btn btn-danger d-inline" name="query-submit" type="submit">restart</button>        
