...
if (isset($_SESSION['userId'])){
    ...
    <div class="col-md-6">
    <form class="form-inline mt-2 mt-md-0" onsubmit="myFunction()">
        <input class="form-control mr-sm-2" type="text" placeholder="Search" name="query" aria-label="Search">
        <button class="btn btn-outline-success my-2 my-sm-0" name="query-submit" onclick="buildWebs" type="submit">Search</button>
      </form>
