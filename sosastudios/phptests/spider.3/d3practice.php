...
<body>
<svg>
<circle r="50" fill="green" stroke="red"cx ="100" cy="50"></circle><text x="100" y="50" stroke="black" fill="black">does this work</text>
</svg>
<style>
div.bar{
...
let h = 10000;
    ...
    .style("right", function(d, i) {		//Set new x position, based on the updated xScale
         return (d[0]+d[2])+"px";
        })    
...
var bottomLeftCircle = d3.select("#circle2")
    ...
    function drawWeb(dataset){  
                       ...
                       var clicked = d3.selectAll("div")	//Select all circles
                                                  .data(dataset);
