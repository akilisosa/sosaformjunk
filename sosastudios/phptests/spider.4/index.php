       ...
       xhr.onload = function (){
        ...
        var item = searchResults.items[0];
         //in production code, item.htmlTitle should have the HTML entities escaped.
          ...
          var myText = document.createTextNode(item.htmlTitle);
          myTextElement.setAttribute("x", "100");
          myTextElement.setAttribute("y", "100");
        ...
        document.getElementById("circle0").appendChild(myTextElement);//get rid maybe
...
echo '   <div class="container form-inline">
        ...
        <button class="btn btn-outline-success my-2 my-sm-0" name="query-submit" onclick="loadText()">Search</button>
